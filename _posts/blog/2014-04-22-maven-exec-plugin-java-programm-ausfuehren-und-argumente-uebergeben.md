...
Um ein Java-Programm auszuführen, gibt man als Parameter **exec.mainClass** die Klasse mit, die die main-Methode enthält. Ein Argument kann man optional mit **exec.args** an die Methode übergeben:
