...
In dem zugehörigen [Bugeintrag bei Eclipse.org](https://bugs.eclipse.org/bugs/show_bug.cgi?id=355955#c16) wird ein Workaround vorgestellt, der einwandfrei
funktioniert.
...
Nach einem Neustart funktioniert Eclipse dann wieder wie gewünscht und zeigt die
